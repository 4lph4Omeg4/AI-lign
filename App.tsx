        ...
        if (allUsers.length === 0) {
            const seedProfiles: UserProfile[] = [
                ...
                },
                {
                    ...
                    name: 'Lily',
                    age: 22,
                    bio: 'Music producer and vinyl collector. Late night studio sessions and finding the perfect beat keep me alive. Tell me your favorite album and why!',
                    interests: ['Music Production', 'Vinyl', 'Nightlife', 'Concerts', 'DJ Sets'],
                ...
                },
                {
                    ...
                    name: 'Zoey',
                    age: 27,
                    bio: 'Adventure photographer capturing life\'s wild moments. Mountains are my office, sunsets are my inspiration. Let\'s chase the light together.',
                    interests: ['Photography', 'Mountains', 'Rock Climbing', 'Van Life', 'Nature'],
                    imageUrl: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?q=80&w=800&auto=format&fit=crop&crop=face',
                    viewCount: 445,
                    likes: [],
                    dislikes: [],
                    matches: [],
                ...
                },
                {
                    ...
                    name: 'Amara',
                    age: 30,
                    bio: 'Marine biologist who discovered my passion underwater. When I\'m not diving with whales, I\'m reading science fiction and dreaming of the stars.',
                    interests: ['Marine Biology', 'Scuba Diving', 'Sci-Fi', 'Astronomy', 'Conservation'],
                ...
                },
                {
                    ...
                    name: 'Ruby',
                    age: 26,
                    bio: 'Pastry chef with a wicked sweet tooth. I turn flour, sugar, and magic into art. Cooking classes and dessert dates? Let\'s make memories.',
                    interests: ['Baking', 'Dessert', 'Foodie', 'Cooking Classes', 'Gourmet'],
                    imageUrl: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?q=80&w=800&auto=format&fit=crop&crop=faces',
                    viewCount: 678,
                    likes: [],
                    dislikes: [],
                    matches: [],
                ...
                },
                {
                    ...
                    name: 'Nora',
                    age: 33,
                    bio: 'Tech entrepreneur building the future. I code by day, meditate by night, and believe work-life balance is everything. Coffee and deep conversations?',
                    interests: ['Technology', 'Entrepreneurship', 'Meditation', 'Coffee', 'Philosophy'],
                    imageUrl: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?q=80&w=800&auto=format&fit=crop',
                    viewCount: 512,
                    likes: [],
                    dislikes: [],
                ...
                },
                {
                    ...
                    name: 'Elena',
                    age: 29,
                    bio: 'Salsa dancer and dance instructor. Movement is my language, rhythm is my soul. Let\'s hit the dance floor and see where the music takes us!',
                    interests: ['Dancing', 'Salsa', 'Latin Music', 'Fitness', 'Flamenco'],
                    imageUrl: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?q=80&w=800&auto=format&fit=crop',
                    viewCount: 723,
                    likes: [],
                    dislikes: [],
                ...
                },
                {
                    ...
                    name: 'Luna',
                    age: 24,
                    bio: 'Astrophotographer capturing galaxies in the desert. I chase darkness for starlight and believe in making every night count.',
                    interests: ['Astrophotography', 'Astronomy', 'Camping', 'Deserts', 'Philosophy'],
                    imageUrl: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?q=80&w=800&auto=format&fit=crop',
                    viewCount: 389,
                    likes: [],
                    dislikes: [],
                ...
                },
                {
                    ...
                    name: 'Iris',
                    age: 28,
                    bio: 'Architect designing sustainable homes. I believe spaces should tell stories. Weekend drives to see beautiful buildings? Count me in!',
                    interests: ['Architecture', 'Design', 'Sustainability', 'Urban Planning', 'Art History'],
                    imageUrl: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?q=80&w=800&auto=format&fit=crop',
                    viewCount: 567,
                    likes: [],
                    dislikes: [],
                ...
                },
                {
                    ...
                    name: 'Aria',
                    age: 21,
                    bio: 'Film student with dreams of directing. Movies, movie theaters, and movie marathons. What\'s your favorite movie scene of all time?',
                    interests: ['Film', 'Cinematography', 'Movie Theaters', 'Popcorn', 'Screenwriting'],
                    imageUrl: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?q=80&w=800&auto=format&fit=crop',
                    viewCount: 945,
                    likes: [],
                    dislikes: [],
                ...
                },
                {
                    ...
                    name: 'Maya',
                    age: 36,
                    bio: 'Clinical psychologist helping others find their path. Balance, mindfulness, and authentic connections matter most. What makes you feel alive?',
                    interests: ['Psychology', 'Therapy', 'Mindfulness', 'Reading', 'Personal Growth'],
                    imageUrl: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?q=80&w=800&auto=format&fit=crop',
                    viewCount: 278,
                    likes: [],
                    dislikes: [],
                ...
                },
                {
                    ...
                    name: 'Scarlett',
                    age: 25,
                    bio: 'MMA fighter and fitness coach. Discipline, strength, and pushing limits. Hit the gym with me and let\'s break a sweat!',
                    interests: ['MMA', 'Fitness', 'Boxing', 'Crossfit', 'Motivation'],
                    imageUrl: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?q=80&w=800&auto=format&fit=crop',
                    viewCount: 651,
                    likes: [],
                    dislikes: [],
                ...
                },
                {
                    ...
                    name: 'Stella',
                    age: 31,
                    bio: 'Sommelier and wine bar owner. I know good wine, good food, and good company. Let\'s discover new flavors together!',
                    interests: ['Wine', 'Fine Dining', 'Wine Tasting', 'Culinary Arts', 'Hospitality'],
                    imageUrl: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?q=80&w=800&auto=format&fit=crop',
                    viewCount: 412,
                    likes: [],
                    dislikes: [],
                ...
                },
                {
                    ...
                    name: 'Pearl',
                    age: 23,
                    bio: 'Jewelry designer creating wearable art. Every piece tells a story. Let\'s craft something beautiful together!',
                    interests: ['Jewelry Design', 'Art', 'Crafts', 'Gems', 'Fashion'],
                    imageUrl: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?q=80&w=800&auto=format&fit=crop',
                    viewCount: 789,
                    likes: [],
                    dislikes: [],
                ...
                },
                {
                    ...
                    name: 'Coral',
                    age: 27,
                    bio: 'Ocean conservationist working to save our seas. Surfboards and sea turtles are my life. Let\'s make waves together!',
                    interests: ['Conservation', 'Surfing', 'Marine Life', 'Eco-Friendly', 'Ocean'],
                    imageUrl: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?q=80&w=800&auto=format&fit=crop',
                    viewCount: 556,
                    likes: [],
                    dislikes: [],
                ...
                },
                {
                    ...
                    name: 'Ivy',
                    age: 30,
                    bio: 'Botanist and greenhouse manager. Plants are my passion. Come see my collection and let\'s grow something together!',
                    interests: ['Botany', 'Plants', 'Greenhouses', 'Gardening', 'Nature'],
                    imageUrl: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?q=80&w=800&auto=format&fit=crop',
                    viewCount: 433,
                    likes: [],
                    dislikes: [],
                ...
                },
                {
                    ...
                    name: 'Sage',
                    age: 26,
                    bio: 'Herbalist and wellness practitioner. Natural remedies and holistic living. Let\'s find balance and health together!',
                    interests: ['Herbalism', 'Wellness', 'Natural Remedies', 'Yoga', 'Meditation'],
                    imageUrl: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?q=80&w=800&auto=format&fit=crop',
                    viewCount: 667,
                    likes: [],
                    dislikes: [],
                ...
                },
                {
                    ...
                    name: 'Dahlia',
                    age: 28,
                    bio: 'Florist and event planner creating magic. Flowers, celebrations, and making moments unforgettable. Let\'s plan something special!',
                    interests: ['Flowers', 'Event Planning', 'Decorations', 'Weddings', 'Celebrations'],
                    imageUrl: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?q=80&w=800&auto=format&fit=crop',
                    viewCount: 834,
                    likes: [],
                    dislikes: [],
                ...
                },
                {
                    ...
                    name: 'Rose',
                    age: 32,
                    bio: 'Romance novelist writing love stories. Books, cafes, and rainy days. Tell me about your favorite love story!',
                    interests: ['Writing', 'Books', 'Romance Novels', 'Coffee Shops', 'Poetry'],
                    imageUrl: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?q=80&w=800&auto=format&fit=crop',
                    viewCount: 322,
                    likes: [],
                    dislikes: [],
                ...
                },
                {
                    ...
                    name: 'Zara',
                    age: 25,
                    bio: 'Fashion blogger documenting street style. City vibes and bold looks. Let\'s explore the urban fashion scene!',
                    interests: ['Fashion', 'Street Style', 'Blogging', 'Urban Life', 'Photography'],
                    imageUrl: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?q=80&w=800&auto=format&fit=crop',
                    viewCount: 1203,
                    likes: [],
                    dislikes: [],
                ...
                },
                {
                    ...
                    name: 'Alexa',
                    age: 27,
                    bio: 'Podcast host diving deep into interesting topics. Conversations, coffee, and compelling stories. Let\'s talk about everything and nothing!',
                    interests: ['Podcasting', 'Interviews', 'Stories', 'Coffee', 'Communication'],
                    imageUrl: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?q=80&w=800&auto=format&fit=crop',
                    viewCount: 745,
                    likes: [],
                    dislikes: [],
